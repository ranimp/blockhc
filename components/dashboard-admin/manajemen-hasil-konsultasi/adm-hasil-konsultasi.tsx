...
const HasilKonsultasiAdmin = () => (
  <div className="overflow-x-auto">
    <table className="w-full text-black border-separate border-spacing-y-2">
      ...
      <tbody>
        <TableKonsultasiDashboardAdmin no="1" walletAddress="0xadfabb0c86b6523ac4a00ba78ebb04532ff863bd2cd292fa8f6c570e0b57f8b7" date="29/10/2022" name="Rani Meliyana Putri" />
      </tbody>
    </table>
  </div>
);

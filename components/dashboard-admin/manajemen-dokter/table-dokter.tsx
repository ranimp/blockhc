...
const TableDokterDashboardAdmin = ({ no, walletAddress, name }) => (
  <tr className="text-center odd:bg-odd-blue even:bg-even-blue">
    ...
    <td className="py-3 flex justify-center gap-3">
      <Link href="/dashboard-admin/manajemen-dokter/detail-dokter">
      ...
      <Link href="/dashboard-admin/manajemen-dokter/update-dokter">
        <button className="hover:text-medium-blue">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">

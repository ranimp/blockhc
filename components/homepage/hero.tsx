  ...
  return (
    <Fragment>
      <div className="px-4 lg:px-16">
        <div className="container px-4 py-4 my-10 lg:mt-20 lg:mb-36 mx-auto w-full relative flex justify-center lg:justify-between flex-wrap lg:flex-nowrap gap-16 items-center">
          ...
          <div className="lg:w-1/2 flex flex-col gap-6">
            ...
            <button className="px-4 py-3 text-white bg-medium-blue capitalize rounded-lg font-medium hover:bg-soft-blue hover:text-medium-blue hover:border-2 border-medium-blue w-80 md:text-2xl hover:opacity-75"><Link href="/">registrasi sekarang</Link></button>
          </div>
        </div>
      </div>
    </Fragment>
